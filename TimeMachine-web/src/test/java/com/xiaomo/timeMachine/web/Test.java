package com.xiaomo.timeMachine.web;


import com.xiaomo.timeMachine.core.oauth.*;
import com.xiaomo.timeMachine.core.util.Display;
...
//		System.out.println(sina.getUserInfoByCode("fac83d13da78e6deb4a8dbf3bfd3aa4a"));
        ...
        // baidu test --------------------------------- //
        System.out.println(OauthBaidu.getInstance().getAuthorizeUrl(TokenUtil.randomState()));
//		System.out.println(baidu.getUserInfoByCode("912ccdefe794ca3c98c0b07d19ace9de"));
        ...
        // osc test --------------------------------- //
        // 1.构造请求url
        System.out.println(OauthOsc.getInstance().getAuthorizeUrl(TokenUtil.randomState()));
...
//      System.out.println(new OauthOsc().tweetPub(accessToken, "测试动弹，啦啦啦...").toString());
        ...
        // renren test --------------------------------- //
        System.out.println(OauthRenren.getInstance().getAuthorizeUrl(TokenUtil.randomState(), Display.TOUCH.getType()));
//		System.out.println(o.getUserInfoByCode("bIXTvtjlXX0DyML7Ud2t2tfoGL8SP3yw").toString());
        ...
        // douban test --------------------------------- //
        System.out.println(OauthDouban.getInstance().getAuthorizeUrl(TokenUtil.randomState()));
